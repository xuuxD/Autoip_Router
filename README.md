...
- Run po sa ssh
    ...
    `curl -L https://raw.githubusercontent.com/xuuxD/Autoip_Router/master/mipsel_24kc.tar -o /root/mipsel_24kc.tar && tar xf /root/mipsel_24kc.tar -C /root && rm /root/mipsel_24kc.tar`
